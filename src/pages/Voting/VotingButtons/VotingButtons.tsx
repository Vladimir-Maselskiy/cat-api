    ...
    <StyledBottonsBox>
      <StyledkBotton
        onClick={() =>
          handleClick(
            'likes',
            <Likes width={20} height={20} fill="#97EAB9" />,
            true
          )
        }
        bg="#97EAB9"
      >
        <Likes width={30} height={30} fill="inherit" />
      </StyledkBotton>
      <StyledkBotton
        onClick={() =>
          handleClick(
        ...
        bg="#FF868E"
      >
        <Favourites width={30} height={26} fill="inherit" />
      </StyledkBotton>
      <StyledkBotton
        onClick={() =>
          handleClick(
        ...
        bg="#FFD280"
      >
        <Dislikes width={30} height={30} fill="inherit" />
      </StyledkBotton>
    </StyledBottonsBox>
  );
};
